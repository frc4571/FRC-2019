...
public class Elevator extends Subsystem {
    ...
    private Elevator() {
        ...
        baseMotor.configContinuousCurrentLimit(20, Constants.timeoutMs);
        baseMotor.configPeakCurrentLimit(40, Constants.timeoutMs);

        baseMotor.configNeutralDeadband(0.06, Constants.timeoutMs);
        ...
        baseMotor.configNominalOutputForward(0, Constants.timeoutMs);
        baseMotor.configNominalOutputReverse(0, Constants.timeoutMs);
        baseMotor.configPeakOutputForward(1, Constants.timeoutMs);
        baseMotor.configPeakOutputReverse(-1, Constants.timeoutMs);
    ...
    public void teleOpInit() {
        baseMotor.configOpenloopRamp(0.35, Constants.timeoutMs);
    }
